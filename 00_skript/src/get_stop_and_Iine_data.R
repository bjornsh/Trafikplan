...
##!! This creates a 1000-object list of which a lot (incl. the first) are NULL.
##!! Either change this loop or delete the NULL right after
...
linje <- linje[-which(sapply(linje, is.null))] ##!! removes Null

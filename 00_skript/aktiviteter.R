...
# indikator 4.2
# Från alla hpl i alla medelstora tätorter (1000-XXX befolkning) som är inte kommunhuvudort till alla respektive 
# kommunhuvudorter i länet finns minst 1 resmöjlighet med max 1 byte mellan 1900 och 2159 på vardagar och helger, och i motsatt riktning.
...
# Bålsta = huvudort för Håbo kommun; Skutskär = huvudort för Älvkarleby kommun
...
# skapas här en df med start och stop hpl i båda riktningar

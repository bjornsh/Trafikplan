...
HplIdKoordinat = sort(list.files("01_input_data/", pattern = "HplData*"), decreasing = TRUE)[1]
HplIdKoordinat = read.csv2(paste0("01_input_data/", HplIdKoordinat))

## senaste filen med alla linjer per hållplats
AllaLinjerPerHplID = sort(list.files("01_input_data/", pattern = "AllaLinjerPerHplID*"), decreasing = TRUE)[1]
AllaLinjerPerHplID = read.csv2(paste0("01_input_data/", AllaLinjerPerHplID))
...
write.csv2(fin, paste0("02_output_data/temp/pendling_", substr(Sys.time(), 1, 10), ".csv"), row.names = F)
...
write.csv2(fin1, paste0("02_output_data/temp/pendling1_", substr(Sys.time(), 1, 10), ".csv"), row.names = F)
...
write.csv2(fin2, paste0("02_output_data/temp/pendling2_", substr(Sys.time(), 1, 10), ".csv"), row.names = F)
...
write.csv2(resultat2, paste0("02_output_data/resultat_pendling_", substr(Sys.time(), 1, 10), ".csv"), row.names = F)
write.csv2(resultat_per_starttatort, paste0("02_output_data/resultat_pendling_starttatort_", substr(Sys.time(), 1, 10), ".csv"), row.names = F)
write.csv2(resultat_per_stoptatort, paste0("02_output_data/resultat_pendling_stoptatort_", substr(Sys.time(), 1, 10), ".csv"), row.names = F)
